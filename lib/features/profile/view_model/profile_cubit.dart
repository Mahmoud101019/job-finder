// ignore_for_file: unnecessary_overrides, avoid_print, depend_on_referenced_packages, unnecessary_import
...
class ProfileCubit extends Cubit<ProfileState> {
  ...
  getProfileDetailsAndPortfolios() {
    ...
    DioHelper.getData(url: portofolioUrl).then((value) {
      // print(value.data);
  ...
  void selectSettingNotificationItem(
      List<NotificationSettingsModel> settings, index, bool value) {
...
//Experience checkBox
  ...
  void addPortofolio() async {
    try {
      ...
      final response =
          await DioHelper.PostFormData(url: portofolioUrl, data: formData);
