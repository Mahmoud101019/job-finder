...
import 'package:job_finder_app/features/search/view/screens/search_screen_result.dart';
import 'package:job_finder_app/features/search/view/widgets/search_result_tile.dart';
        ...
        child: BlocBuilder<SearchCubit, SearchState>(
          builder: (context, state) {
            return BuildCondition(
              ...
              builder: (context) => const SearchScreenResult(),
